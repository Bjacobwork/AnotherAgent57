...
if __name__ == "__main__":
    ...
    for i in range(250):
        transitions = []
        for i in range(100):
            transitions.append([eid,i+offset,random.randrange(100),random.randrange(100),0,obs.tobytes(), h.tobytes(), random.random(),random.randrange(100),random.randrange(100)])
        offset += 100
