...
class Environment:
    ...
    def __init__(self, environment_name, obs_type, frameskip, max_episode_length, index, actions, observations, rewards,
                 steps, resets, loss_of_life, reward_scale):
...
if __name__ == "__main__":
    ...
    env = Environment(environment_name, obs_type, max_episode_length, 0, foo.actions, foo.observations,
                      foo.extrinsic_rewards, foo.resets)
    times = []
